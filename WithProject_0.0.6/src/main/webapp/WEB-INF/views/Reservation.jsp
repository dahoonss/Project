...
<input type="button" class="w3-button w3-white w3-padding-large w3-hover-black" onclick="location.href='map2?rStart=${Room.rStart}&rEnd=${Room.rEnd}&roomId=${Room.roomId}&opGender=${Room.opGender}'" value="지도">
          </li>
        </ul>
      </div>
</form>
