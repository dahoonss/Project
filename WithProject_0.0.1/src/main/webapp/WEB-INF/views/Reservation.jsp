...
<form action="ReservationRoom" method="post">
...
날짜선택:<input class="date-picker" type="text" name="Dayday" required autofocus/>
시간선택:<select name="Times" required autofocus>
...
<input type="submit" value="예약한 내역 보러가기">
</form>
